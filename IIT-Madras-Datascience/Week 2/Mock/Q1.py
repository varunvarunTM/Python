""" You have n gold coins with you. You wish to divide this among three of your friends under the following conditions:
    ...
    The next three lines will have the share given to your three friends. All inputs shall be non-negative integers.
    If the division satisfies these conditions, then print the string FAIR. If not, print UNFAIR."""



t,a,b,c = int(input()),int(input()),int(input()),int(input())
x = (a != 0 and b != 0 and c != 0) and (a != b and b != c and c != a) and (t - (a+b+c) == 0)
if x:
    print("FAIR")
else:
    print("UNFAIR")